...
<html lang="en">
	...
	<body id="kt_body" style="background-image: url(assets/media/bg/bg-10.jpg)" class="page-loading-enabled page-loading quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled aside-enabled aside-static page-loading">
