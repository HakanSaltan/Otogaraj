...
<body id="kt_body"  class="page-loading-enabled page-loading quick-panel-right demo-panel-right offcanvas-right header-fixed aside-enabled aside-static page-loading">
    <!--begin::Main Mainin-->
