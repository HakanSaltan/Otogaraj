                    ...
                    <ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0" role="tablist">
                        ...
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center">
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bold text-center"  v-text="aracDetay.plaka"></span>
                            </a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center">
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bolder text-center"  v-text="aracDetay.markaAdi"></span>
                            </a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center">
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bolder text-center"  v-text="aracDetay.modelAdi"></span>
                            </a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 ">
                            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center">
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bolder text-center">2018 MODEL</span>
                            </a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-0 mb-3 mb-lg-0">
                            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center">
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bolder text-center" v-text="aracDetay.km"></span>
                            </a>
                        </li>
                        <!--end::Item-->
                    ...
                    <div class="d-flex justify-content-between flex-column pt-4 h-100">
                        ...
                        <div class="pb-5">
                            ...
                            <div class="d-flex flex-column flex-center">
                                <!--begin::Username-->
                                <a class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">Yapılan İşlemler burada görüntülenecektir.</a>
                                <!--end::Username-->
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
